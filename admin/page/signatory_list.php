...
$offices_id=$_GET['offices_id'];
	...
	if(isset($_POST['add'])){
        ...
        for ($i=0; $i < $base_section; $i++) { 
        	...
        	$sql = "SELECT * FROM $table  WHERE  offices_id='$offices_id' AND courses_id='$courses[$i]';";
				...
				if ($result->num_rows > 0) {
				  // output data of each row
		        	...
		        	if($i==0){
						$sql1 = "INSERT INTO $table SET $data, courses_id='$courses[$i]'; ";
		        	}else{
		        		$sql1 .= "INSERT INTO $table SET $data, courses_id='$courses[$i]'; ";
		        	}
		        }
        ...
        if ($conn->multi_query($sql1) === TRUE) {
            ...
            ?>
            	<script type="text/javascript">
            		...
            		location.href="?page=<?php echo$page?>&offices_id=<?php echo$offices_id?>";
            	</script>
            <?php
	...
	<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
	    ...
	    <tbody>
	    	<?php
	    		...
	    		FROM $table t WHERE offices_id='$offices_id'";
				$result = $conn->query($sql);
        ...
        <div class="modal-content">
            ...
            <form method="POST">
            	<div class="modal-body">
            		...
            		<select class="form-select form-select-solid" data-control="select2"  data-close-on-select="false" data-placeholder="Select an courses" data-allow-clear="true" multiple="multiple" name="courses[]">
              			<?php
							...
							if ($result->num_rows > 0) {
							  ...
							  while($row = $result->fetch_assoc()) {
							  	extract($row);
							    ?><option value="<?php echo$id?>"><?php echo$name?> <?php echo$year_level?><?php echo$section?></option><?php
							  }
							}
              			?>
					</select>
