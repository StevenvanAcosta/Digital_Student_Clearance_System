						...
						<div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_forms" data-kt-redirect-url="index.html" action="login-function.php" method="POST">
								...
								<div class="text-center mb-11">
									...
									<h2 class="text-gray ">Bulacan Polytechnic College Student Clearance System</h2>
									<!--end::Title-->
									<!--begin::Subtitle-->
								...
								<!--end::Submit button-->
								<div class="d-grid mb-10">
									<a href="./" id="kt_sign_in_submits" class="btn btn-secondary">
										<!--begin::Indicator label-->
										<span class="indicator-label">Student Login</span>
										<!--end::Indicator label-->
										<!--begin::Indicator progress-->
										<span class="indicator-progress">Please wait... 
										<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
